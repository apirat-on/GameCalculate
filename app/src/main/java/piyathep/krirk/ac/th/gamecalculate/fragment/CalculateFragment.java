...
public class CalculateFragment extends Fragment implements View.OnClickListener {
    ...
    private Button buttonC, button1, button2, button3, button4, button5, button6, button7, button8, button9, button0, buttonDivide,
...
//                Show Display
    ...
    private void initialView() {
        ...
        buttonDivide = getActivity().findViewById(R.id.btnDivide);
